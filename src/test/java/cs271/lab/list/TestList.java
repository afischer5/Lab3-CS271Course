...
public class TestList {
  ...
  public void setUp() throws Exception { 
    ...
    // DISCUSS also try with a LinkedList - does it make any difference?
  }
  ...
  public void testRemoveObject() {
    ...
    list.add(77);
    list.add(6);
    list.remove(5); //DISCUSS what does this method do?
    // DONE fix the expected values in the assertions below
    ...
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); //DISCUSS what does this one do?
  ...
  public void testContainsAll() {
    ...
    List<Integer> testList = new LinkedList<Integer>(Arrays.asList(33,77,44,77,55,77,66));
    assertEquals(true, list.containsAll(testList));
    // 2) assert that list does not contain all of 11, 22, and 33
    List<Integer> testListTwo = new LinkedList<Integer>(Arrays.asList(11,22,33));
    assertEquals(false, list.containsAll(testListTwo));
  ...
  public void testAddAll() {
    ...
    list.addAll(0, Arrays.asList(33, 77, 44, 77, 55, 77, 66));
